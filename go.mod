...
replace (
	...
	k8s.io/api => k8s.io/api v0.34.3 // kubernetes-1.16.0
	k8s.io/apimachinery => k8s.io/apimachinery v0.34.3 // kubernetes-1.16.0
	k8s.io/apiserver => k8s.io/apiserver v0.34.3 // kubernetes-1.16.0
	k8s.io/client-go => k8s.io/client-go v0.34.3 // kubernetes-1.16.0
	k8s.io/cluster-bootstrap => k8s.io/cluster-bootstrap v0.34.3 // kubernetes-1.16.0
	k8s.io/code-generator => k8s.io/code-generator v0.34.3 // kubernetes-1.16.0
